...
def add_expeditions():
    ...
    if len(users) == 0 or len(moderators) == 0:
        print("Экспедиция не могут быть добавлены. Сначала добавьте пользователей с помощью команды add_users")
        return
